...
dataFileName = "FitResults/2018_01_14/fitOutput_Data_MuTau2017BCDEF.root"
# ROOT FILE CONTAINING THE MC
mcFileName = "FitResults/2018_01_14/fitOutput_MC_MuTau2017_DY1JetsFall17_v2.root"
...
for trigger in triggers:
    ...
    turnon_MC.append(TurnOnPlot.TurnOn(Name="Stage2_MC", Histo=histo_MC[-1], Fit=fit_MC[-1],
                                   ...
                                   Legend="MC 2017, DYJets"))
    plots.append(TurnOnPlot.TurnOnPlot(TriggerName = trigger + "Data - MC"))
    plots[-1].name = "turnOn_2017_CombinedData_vs_MC_" + trigger
