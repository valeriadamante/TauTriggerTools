...
import numpy as np
from gp_monotonic import monotonic
...
class FitResults:
    def __init__(self, eff, x_pred,channel):
        ...
        kernel_default = RBF(length_scale=20.0, length_scale_bounds=(10, 100.0))
        ...
        gp_mon = monotonic(gp_default,eff.x,eff.y,yerr)
        self.y_pred,y_cov = gp_mon.predict(x_pred)
