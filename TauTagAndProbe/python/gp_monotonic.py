...
class gp_monotonic:
    def __init__(self,kernel,gp,xvals,ydata):
        self.kernel = kernel # default gp model
        ...
        for iteration in range(10):
            ...
            for i in range(M):
                ...
                #######################################################################################
                #update posterior
                m_new,v_new,Zi = self.compute_moments(self.ydata[i], cavity_m,cavity_v)
        ...
        self.kernel_new = Matern(length_scale=1.5, length_scale_bounds=(1,3), nu=0.75)
